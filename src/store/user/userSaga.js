...
import { getCurrentUser, createUserDocumentFromAuth, 
  logInWithEmailAndPassword, signInWithGooglePopup, registerUserWithEmailAndPassword, signOutUser } from '../../utilities/firebase/firebase'



import { USER_ACTION_TYPES } from './userActionTypes'

import { signInSuccess, signInFailure, signUpFailure, signUpSuccess, signOutSuccess, signOutFailure } from './userActions'
...
export function* userSaga(){
    yield all([call(checkUserSession), call(onSignInWithGoogle), call(onSignInWithEmailAndPassword), call(onSignUpStart), call(onSignUpSuccess), call(onSignOutStart)])
}